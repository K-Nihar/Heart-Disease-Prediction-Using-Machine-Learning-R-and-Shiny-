               ...
               fluidRow(
                 column(width = 6,
                        box( title = h4("Enter Personal Details"),
                             ...
                             textInput("restingbp", label =("Resting Blood Pressure"), value = "150"),helpText("in mm/Hg"),
                             
                             textInput("cholestrol", label =("Cholestrol"), value = "150"), helpText("Range=100-189 mg/dL"),
                             ...
                             textInput("maxheartrate", label =("Max Heart Rate Achieved"),  value = "180"),
                             
                             textInput("exang", label =("Exercise induced angina"),  value = "1"), helpText("0- no,1-yes"),
                             
                             textInput("oldpeak", label =("ST depression induced due to exercise"),  value = "3.5"),
                             
                             textInput("slope", label =("Slope of peak ST segment"),  value = "1"), helpText("1: upsloping 2: flat 3: downsloping"),
                             
                             textInput("ca", label =("Number of major vessels coloured by fluroscopy"), value = "2"), helpText("0 - 3"),
                             
                             textInput("thal", label =("Thal value"),value = "6"), helpText("3-normal,6-fixed defect,7-reversible defect")
